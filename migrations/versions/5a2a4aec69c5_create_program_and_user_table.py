...
def upgrade():
    ...
    # Create foreign keys
    op.create_foreign_key("author_id", "program", "user", ["author"], ["id"])
    op.create_foreign_key("current_program_id", "user", "program", ["current_program"], ["id"])
...
def downgrade():
    ...
    op.drop_index(op.f('ix_program_author'), table_name='program')
